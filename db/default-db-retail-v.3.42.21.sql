...
insert  into `pos_printer`(`id`,`printer_ip`,`printer_name`,`printer_tipe`,`printer_pin`,`is_print_anywhere`,`createdby`,`created`,`updatedby`,`updated`,`is_active`,`is_deleted`,`print_method`,`print_logo`) values (1,'pc-share-name\\printer-share-name','KASIR','QPOS','32 CHAR',0,'system','2017-05-05 12:57:37','admin','2019-04-28 21:22:22',1,0,'BROWSER',0);
