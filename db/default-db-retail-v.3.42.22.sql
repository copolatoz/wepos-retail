...
WePOS.Retail : v.3.42.22 (Januari 2021)
...
(1, 'Hutang Pembelian Bahan Baku ke Supplier', 'account_payable', 24, 74, 'administrator', '2016-04-05 14:47:27', 'administrator', '2016-04-05 14:47:39', 1, 1),
(2, 'Hutang Pembelian Supplier', 'account_payable', 31, 74, 'administrator', '2016-04-05 14:47:27', 'ane', '2017-12-18 09:37:25', 1, 0),
(3, 'Pelunasan Hutang Supplier via Kas Besar', 'pelunasan_account_payable', 74, 9, 'administrator', '2016-04-05 14:47:27', 'administrator', '2016-04-05 14:47:27', 1, 0),
(4, 'Pelunasan Hutang Supplier via Bank Mandiri', 'pelunasan_account_payable', 74, 12, 'administrator', '2016-04-05 14:47:27', 'administrator', '2016-04-05 14:47:27', 1, 0),
(5, 'Pelunasan Hutang Supplier via Bank BCA', 'pelunasan_account_payable', 74, 13, 'administrator', '2016-04-05 14:47:27', 'administrator', '2016-04-05 14:47:27', 1, 0),
(6, 'Piutang Penjualan (Sales/Cashier)', 'account_receivable', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0),
(7, 'Piutang Penjualan (Sales Order/Reservasi)', 'account_receivable', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0),
(8, 'Piutang Penjualan (Marketplace/Online)', 'account_receivable', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0),
(9, 'Pembayaran Piutang via Kas Besar', 'pembayaran_account_receivable', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0),
(10, 'Pembayaran Piutang via Bank BCA', 'pembayaran_account_receivable', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0),
(11, 'Pembayaran Piutang via Bank Mandiri', 'pembayaran_account_receivable', NULL, NULL, NULL, NULL, NULL, NULL, 1, 0),
(12, 'Retur Pembelian', 'account_receivable', NULL, NULL, 'next', '2017-12-22 07:38:36', 'next', '2017-12-22 07:38:36', 1, 0);
...
(1, 'MERCHANT-KEY', 'MERCHANT NAME', 'MERCHANT ADDRESS', NULL, 0, NULL, NULL, '081-000-000', '-', 'youremail@email.id', 'logo.png', NULL, NULL, '', '2019-03-07 21:07:01', 'admin', '2019-11-18 20:33:45', 1, 0, NULL, NULL, NULL, NULL, NULL, 'unverified', '0');
...
(1, 'Setup Aplikasi', 'dev@wepos.id', 'v.1.0', '', 'systems', 'setupAplikasiFree', 1, '1. Master Aplikasi>Setup Aplikasi', 1, 'icon-cog', 'icon-cog', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Setup Aplikasi', 1000, 'icon-cog', '', 0, 'icon-cog', '', 1, 'icon-cog', '', 0, 'icon-cog', '', 'administrator', '2018-07-10 01:52:11', 'administrator', '2018-07-29 17:00:00', 1, 0),
(2, 'Client Info', 'dev@wepos.id', 'v.1.0.0', 'Client Info', 'systems', 'clientInfo', 0, '1. Master Aplikasi>Client Info', 1, 'icon-home', 'icon-home', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Client Info', 1101, 'icon-home', '', 0, 'icon-home', '', 1, 'icon-home', '', 1, 'icon-home', '', 'administrator', '2018-07-03 00:47:08', 'administrator', '2018-07-03 00:47:08', 1, 0),
(3, 'Client Unit', 'dev@wepos.id', 'v.1.0', '', 'systems', 'DataClientUnit', 1, '1. Master Aplikasi>Client Unit', 1, 'icon-building', 'icon-building', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Client Unit', 1102, 'icon-building', '', 0, 'icon-building', '', 1, 'icon-building', '', 1, 'icon-building', '', 'administrator', '2018-07-10 01:52:10', 'administrator', '2018-07-29 17:00:00', 1, 0),
(4, 'Data Structure', 'dev@wepos.id', 'v.1.0', '', 'systems', 'DataStructure', 1, '1. Master Aplikasi>Data Structure', 1, 'icon-building', 'icon-building', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Data Structure', 1103, 'icon-building', '', 0, 'icon-building', '', 1, 'icon-building', '', 1, 'icon-building', '', 'administrator', '2018-07-10 01:52:11', 'administrator', '2018-07-29 17:00:00', 1, 0),
(5, 'Role Manager', 'dev@wepos.id', 'v.1.2', 'Role Manager', 'systems', 'Roles', 1, '1. Master Aplikasi>Role Manager', 1, 'icon-role-modules', 'icon-role-modules', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Role Manager', 1201, 'icon-role-modules', '', 0, 'icon-role-modules', '', 1, 'icon-role-modules', '', 1, 'icon-role-modules', '', 'administrator', '2018-07-10 01:52:15', 'administrator', '2018-07-29 17:00:00', 1, 0),
(6, 'Data User', 'dev@wepos.id', 'v.1.0', '', 'systems', 'UserData', 1, '1. Master Aplikasi>Data User', 1, 'icon-user-data', 'icon-user-data', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Data User', 1203, 'icon-user-data', '', 0, 'icon-user-data', '', 1, 'icon-user-data', '', 0, 'icon-user-data', '', 'administrator', '2018-07-10 01:52:11', 'administrator', '2018-07-29 17:00:00', 1, 0),
(7, 'User Profile', 'dev@wepos.id', 'v.1.0', '', 'systems', 'UserProfile', 1, '1. Master Aplikasi>User Profile', 1, 'user', 'user', '', '', 1, 0, 1, 1, '1. Master Aplikasi>User Profile', 1301, 'user', '', 1, 'user', '', 1, 'user', '', 1, 'user', '', 'administrator', '2018-07-10 01:52:17', 'administrator', '2018-07-29 17:00:00', 1, 0),
(8, 'Desktop Shortcuts', 'dev@wepos.id', 'v.1.0', 'Shortcuts Manager to Desktop', 'systems', 'DesktopShortcuts', 1, '1. Master Aplikasi>Desktop Shortcuts', 1, 'icon-preferences', 'icon-preferences', '', '', 1, 0, 1, 1, '1. Master Aplikasi>Desktop Shortcuts', 1302, 'icon-preferences', '', 1, 'icon-preferences', '', 1, 'icon-preferences', '', 1, 'icon-preferences', '', 'administrator', '2018-07-10 01:52:12', 'administrator', '2018-07-29 17:00:00', 1, 0),
(9, 'QuickStart Shortcuts', 'dev@wepos.id', 'v.1.0', '', 'systems', 'QuickStartShortcuts', 0, '1. Master Aplikasi>QuickStart Shortcuts', 1, 'icon-preferences', 'icon-preferences', '', '', 1, 0, 1, 0, '1. Master Aplikasi>QuickStart Shortcuts', 1303, 'icon-preferences', '', 0, 'icon-preferences', '', 1, 'icon-preferences', '', 1, 'icon-preferences', '', 'administrator', '2018-07-24 00:43:19', 'administrator', '2018-07-21 02:16:19', 1, 0),
(10, 'Refresh Aplikasi', 'dev@wepos.id', 'v.1.0.0', '', 'systems', 'refreshModule', 0, 'Refresh Aplikasi', 1, 'icon-refresh', 'icon-refresh', '', '', 1, 0, 0, 0, 'Refresh Aplikasi', 1304, 'icon-refresh', '', 0, 'icon-refresh', '', 1, 'icon-refresh', '', 0, 'icon-refresh', '', 'administrator', '2018-07-17 08:00:19', 'administrator', '2018-07-17 08:00:19', 1, 0),
(11, 'Lock Screen', 'dev@wepos.id', 'v.1.0.0', 'User Lock Screen', 'systems', 'lockScreen', 0, 'LockScreen', 1, 'icon-grid', 'icon-grid', '', '', 1, 1, 0, 0, 'LockScreen', 1305, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-16 18:40:20', 'administrator', '2018-07-29 17:00:00', 1, 0),
(12, 'Logout', 'dev@wepos.id', 'v.1.0.0', 'Just Logout Module', 'systems', 'logoutModule', 0, 'Logout', 1, 'icon-grid', 'icon-grid', '', '', 1, 1, 0, 0, 'Logout', 1306, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-16 18:36:16', 'administrator', '2018-07-20 08:06:35', 1, 0),
(13, 'WePOS Update', 'dev@wepos.id', 'v.1.0.0', 'WePOS Update', 'systems', 'weposUpdate', 0, '1. Master Aplikasi>WePOS Update', 1, 'icon-sync', 'icon-grid', '', '', 1, 0, 1, 0, '1. Master Aplikasi>WePOS Update', 1401, 'icon-sync', '', 0, 'icon-sync', '', 1, 'icon-sync', '', 1, 'icon-sync', '', 'administrator', '2018-07-22 01:00:58', 'administrator', '2018-07-22 01:00:58', 1, 0),
(14, 'Notifikasi Sistem', 'dev@wepos.id', 'v.1.0.0', 'Notifikasi Sistem', 'systems', 'systemNotify', 0, 'Notifikasi Sistem', 1, 'icon-info', 'icon-info', '', '', 1, 1, 0, 0, 'Notifikasi Sistem', 1402, 'icon-info', '', 0, 'icon-info', '', 0, 'icon-info', '', 0, 'icon-info', '', 'administrator', '2018-07-22 01:00:58', 'administrator', '2018-07-22 01:00:58', 1, 0),
(17, 'Master Warehouse', 'dev@wepos.id', 'v.1.0.0', 'Master Warehouse', 'master_pos', 'masterStoreHouse', 0, '2. Master POS>Master Warehouse', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Warehouse', 2201, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-09 20:24:56', 'administrator', '2018-07-21 13:05:16', 1, 0),
(18, 'Master Unit', 'dev@wepos.id', 'v.1.0.0', 'Master Unit', 'master_pos', 'masterUnit', 0, '2. Master POS>Master Unit', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Unit', 2202, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-09 20:25:13', 'administrator', '2018-07-12 15:15:29', 1, 0),
(19, 'Master Supplier', 'dev@wepos.id', 'v.1.0.0', 'Master Supplier', 'master_pos', 'masterSupplier', 0, '2. Master POS>Supplier', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Supplier', 2203, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-09 20:25:04', 'administrator', '2018-07-21 13:04:34', 1, 0),
(20, 'Item Category', 'dev@wepos.id', 'v.1.0.0', 'Item Category', 'master_pos', 'itemCategory', 0, '2. Master POS>Item Category', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Item Category', 2210, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-04 17:36:29', 'administrator', '2018-07-15 13:31:54', 1, 0),
(21, 'Sub Item Category', 'dev@wepos.id', 'v.1.0.0', 'Sub Item Category', 'master_pos', 'itemSubCategory', 0, '2. Master POS>Sub Item Category', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Sub Item Category', 2221, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-12 15:16:35', 'administrator', '2018-07-05 03:25:39', 1, 0),
(25, 'Master Item', 'dev@wepos.id', 'v.1.0.0', 'Data Item', 'master_pos', 'masterItemRetail', 0, '2. Master POS>Master Item', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Item', 2230, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-13 07:04:34', 'administrator', '2018-07-13 07:04:34', 1, 0),
(26, 'Discount Planner', 'dev@wepos.id', 'v.1.0', 'Planning All discount', 'master_pos', 'discountPlannerFree', 0, '2. Master POS>Discount Planner', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Discount Planner', 2301, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-10 10:26:01', 'administrator', '2018-07-29 17:00:00', 1, 0),
(27, 'Printer Manager', 'dev@wepos.id', 'v.1.0', 'Printer Manager', 'master_pos', 'masterPrinter', 0, '2. Master POS>Printer Manager', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Printer Manager', 2302, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-09 20:24:50', 'administrator', '2018-07-21 13:06:25', 1, 0),
(28, 'Master Tipe Billing', 'dev@wepos.id', 'v.1.0.0', '', 'master_pos', 'masterTipeBilling', 0, '2. Master POS>Master Tipe Billing', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Tipe Billing', 2309, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-10 10:26:54', 'administrator', '2018-07-29 17:00:00', 1, 0),
(30, 'Master Bank', 'dev@wepos.id', 'v.1.0.0', 'Master Bank', 'master_pos', 'masterBank', 0, '2. Master POS>Master Bank', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Bank', 2304, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-09 20:24:53', 'administrator', '2018-07-21 13:05:03', 1, 0),
(33, 'Warehouse Access', 'dev@wepos.id', 'v.1.0.0', 'Warehouse Access', 'master_pos', 'warehouseAccess', 0, '2. Master POS>User Access>Warehouse Access', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>User Access>Warehouse Access', 2401, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-27 12:23:32', 'administrator', '2018-07-21 13:02:49', 1, 0),
(34, 'Printer Access', 'dev@wepos.id', 'v.1.0.0', 'Printer Access', 'master_pos', 'printerAccess', 0, '2. Master POS>User Access>Printer Access', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>User Access>Printer Access', 2402, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-02 23:43:42', 'administrator', '2018-07-21 13:02:38', 1, 0),
(35, 'Supervisor Access', 'dev@wepos.id', 'v.1.0.0', 'Supervisor Access', 'master_pos', 'supervisorAccess', 0, '2. Master POS>User Access>Supervisor Access', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>User Access>Supervisor Access', 2403, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-11 15:53:04', 'administrator', '2018-07-21 13:02:58', 1, 0),
(37, 'Open Cashier (Shift)', 'dev@wepos.id', 'v.1.0', '', 'cashier', 'openCashierShift', 0, '3. Cashier & Sales Order>Open Cashier (Shift)', 7, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Sales Order>Open Cashier (Shift)', 3001, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-10 10:28:12', 'administrator', '2018-07-29 17:00:00', 1, 0),
(38, 'Close Cashier (Shift)', 'dev@wepos.id', 'v.1.0', '', 'cashier', 'closeCashierShift', 0, '3. Cashier & Sales Order>Close Cashier (Shift)', 7, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Sales Order>Close Cashier (Shift)', 3002, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-10 10:28:17', 'administrator', '2018-07-29 17:00:00', 1, 0),
(39, 'List Open Close Cashier', 'dev@wepos.id', 'v.1.0.0', '', 'cashier', 'listOpenCloseCashier', 0, '3. Cashier & Sales Order>List Open Close Cashier', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Sales Order>List Open Close Cashier', 3003, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-20 00:59:55', 'administrator', '2018-07-20 00:59:55', 1, 0),
(40, 'Cashier', 'dev@wepos.id', 'v.1.0', 'Cashier', 'cashier', 'billingCashierRetail', 0, '3. Cashier & Sales Order>Cashier Retail', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Sales Order>Cashier Retail', 3101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-09 20:28:03', 'administrator', '2018-07-22 05:58:59', 1, 0),
(46, 'Cashier Receipt Setup', 'dev@wepos.id', 'v.1.0.0', 'Cashier Receipt Setup', 'cashier', 'cashierReceiptSetupRetail', 0, '3. Cashier & Sales Order>Cashier Receipt Setup', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Sales Order>Cashier Receipt Setup', 3301, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-10 23:13:49', 'administrator', '2018-07-22 05:59:09', 1, 0),
(50, 'Purchase Order/Pembelian', 'dev@wepos.id', 'v.1.0.0', 'Purchase Order/Pembelian', 'purchase', 'purchaseOrder', 0, '4. Purchase & Receive>Purchase Order/Pembelian', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '4. Purchase & Receive>Purchase Order/Pembelian', 4201, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-09 20:27:18', 'administrator', '2018-07-15 08:07:08', 1, 0),
(51, 'Receiving List/Penerimaan Barang', 'dev@wepos.id', 'v.1.0.0', 'Receiving List/Penerimaan Barang', 'inventory', 'receivingList', 0, '4. Purchase & Receive>Receiving List/Penerimaan Barang', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '4. Purchase & Receive>Receiving List/Penerimaan Barang', 4301, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-10 05:05:57', 'administrator', '2018-07-22 06:04:22', 1, 0),
(52, 'Daftar Stok Barang', 'dev@wepos.id', 'v.1.0.0', 'Daftar Stok Barang', 'inventory', 'listStock', 0, '5. Inventory>Daftar Stok Barang', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '5. Inventory>Daftar Stok Barang', 5101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-02 23:43:42', 'administrator', '2018-07-24 06:22:20', 1, 0),
(57, 'Stock Opname', 'dev@wepos.id', 'v.1.0.0', 'Module Stock Opname', 'inventory', 'stockOpname', 0, '5. Inventory>Stock Opname', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '5. Inventory>Stock Opname', 5401, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-10 05:06:05', 'administrator', '2018-07-24 06:22:51', 1, 0),
(76, 'Closing Sales', 'dev@wepos.id', 'v.1.0.0', 'Closing Sales', 'audit_closing', 'closingSales', 0, '8. Closing & Audit>Closing Sales', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '8. Closing & Audit>Closing Sales', 8101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-03 14:43:42', 'administrator', '2018-07-03 14:43:42', 1, 0),
(77, 'Closing Purchasing', 'dev@wepos.id', 'v.1.0.0', 'Closing Purchasing', 'audit_closing', 'closingPurchasing', 0, '8. Closing & Audit>Closing Purchasing', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '8. Closing & Audit>Closing Purchasing', 8102, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-03 14:47:56', 'administrator', '2018-07-03 14:51:27', 1, 0),
(79, 'Auto Closing Generator', 'dev@wepos.id', 'v.1.0.0', 'Auto Closing Generator', 'monitoring', 'generateAutoClosing', 0, '9. Sync, Backup, Generate>Auto Closing Generator', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '9. Sync, Backup, Generate>Auto Closing Generator', 9102, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-03 14:43:42', 'administrator', '2018-07-03 14:43:42', 0, 1),
(80, 'Backup Master Data', 'dev@wepos.id', 'v.1.0.0', 'Backup Master Data', 'sync_backup', 'syncData', 0, '9. Sync, Backup, Generate>Backup Master Data', 1, 'icon-sync', 'icon-sync', '', '', 1, 0, 1, 0, '9. Sync, Backup, Generate>Backup Master Data', 9201, 'icon-sync', '', 0, 'icon-sync', '', 1, 'icon-sync', '', 1, 'icon-sync', '', 'administrator', '2018-07-25 05:14:44', 'administrator', '2018-07-26 14:05:47', 1, 0),
...
(82, 'Generate Report Summary', 'dev@wepos.id', 'v.1.0.0', 'Generate Report Summary', 'generate', 'generateReport', 0, '9. Sync, Backup, Generate>Generate Report Summary', 1, 'icon-generate', 'icon-generate', '', '', 1, 0, 0, 0, '9. Sync, Backup, Generate>Generate Report Summary', 9301, 'icon-generate', '', 0, 'icon-generate', '', 1, 'icon-generate', '', 1, 'icon-generate', '', 'administrator', '2018-07-26 14:10:03', 'administrator', '2018-07-26 14:10:03', 0, 1),
(83, 'Sync & Backup', 'dev@wepos.id', 'v.1.0.0', 'Sync & Backup', 'sync_backup', 'syncBackup', 0, '9. Sync, Backup, Generate>Sync & Backup', 1, 'icon-sync', 'icon-sync', '', '', 1, 0, 1, 0, '9. Sync, Backup, Generate>Sync & Backup', 9203, 'icon-sync', '', 0, 'icon-sync', '', 1, 'icon-sync', '', 1, 'icon-sync', '', 'administrator', '2018-07-25 05:14:44', 'administrator', '2018-07-26 14:05:47', 0, 1),
(84, 'Sales Report', 'dev@wepos.id', 'v.1.0', 'Sales Report', 'billing', 'reportSales', 0, '6. Reports>Sales (Billing)>Sales Report', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Billing)>Sales Report', 6101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-10 18:28:24', 'administrator', '2018-07-17 10:01:16', 1, 0),
(87, 'Sales Report (Recap)', 'dev@wepos.id', 'v.1.0.0', '', 'billing', 'reportSalesRecap', 0, '6. Reports>Sales (Billing)>Sales Report (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Billing)>Sales Report (Recap)', 6104, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-24 09:30:29', 'administrator', '2018-07-24 09:38:02', 1, 0),
(88, 'Sales By Discount', 'dev@wepos.id', 'v.1.0.0', 'Sales By Discount', 'billing', 'salesByDiscount', 0, '6. Reports>Sales (Billing)>Sales By Discount', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Billing)>Sales By Discount', 6105, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-15 13:43:42', 'administrator', '2018-07-15 13:43:42', 1, 0),
(94, 'Cancel Billing Report', 'dev@wepos.id', 'v.1.0.0', '', 'billing', 'reportCancelBill', 0, '6. Reports>Sales (Billing)>Report Cancel Billing', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Billing)>Report Cancel Billing', 6110, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-19 02:45:34', 'administrator', '2018-07-24 09:26:54', 1, 0),
(96, 'Sales By Item', 'dev@wepos.id', 'v.1.0.0', 'Sales By Item', 'billing', 'reportSalesByItem', 0, '6. Reports>Sales (Item)>Sales By Item', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Item)>Sales By Item', 6111, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-08 22:51:55', 'administrator', '2018-07-17 10:47:33', 1, 0),
(103, 'Sales Profit Report', 'dev@wepos.id', 'v.1.0.0', '', 'billing', 'reportSalesProfit', 0, '6. Reports>Sales (Profit)>Sales Profit Report', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Profit)>Sales Profit Report', 6131, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-24 09:46:57', 'administrator', '2018-07-24 10:21:51', 1, 0),
(106, 'Sales Profit Report (Recap)', 'dev@wepos.id', 'v.1.0.0', '', 'billing', 'reportSalesProfitRecap', 0, '6. Reports>Sales (Profit)>Sales Profit Report (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Profit)>Sales Profit Report (Recap)', 6134, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-24 09:58:17', 'administrator', '2018-07-24 10:23:59', 1, 0),
(107, 'Sales Profit By Item', 'dev@wepos.id', 'v.1.0.0', 'Sales Profit By Item', 'billing', 'reportSalesProfitByItem', 0, '6. Reports>Sales (Profit)>Sales Profit By Item', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Profit)>Sales Profit By Item', 6135, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-24 09:53:21', 'administrator', '2018-07-17 12:38:07', 1, 0),
(130, 'Bagi Hasil', 'dev@wepos.id', 'v.1.0.0', 'Bagi Hasil Detail', 'billing', 'reportSalesBagiHasil', 0, '6. Reports>Sales (Bagi Hasil)>Bagi Hasil', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Bagi Hasil)>Bagi Hasil', 6301, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-14 23:43:42', 'administrator', '2018-07-14 23:43:42', 1, 0),
(131, 'Bagi Hasil (Recap)', 'dev@wepos.id', 'v.1.0.0', 'Bagi Hasil (Recap)', 'billing', 'reportSalesBagiHasilRecap', 0, '6. Reports>Sales (Bagi Hasil)>Bagi Hasil (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Bagi Hasil)>Bagi Hasil (Recap)', 6302, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-14 23:43:42', 'administrator', '2018-07-14 23:43:42', 1, 0),
(136, 'Purchase Report', 'dev@wepos.id', 'v.1.0.0', 'Purchase Report', 'purchase', 'reportPurchase', 0, '6. Reports>Purchase/Pembelian>Purchase Report', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Purchase/Pembelian>Purchase Report', 6401, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-16 14:28:58', 'administrator', '2018-07-09 12:08:45', 1, 0),
(138, 'Purchase Report (Recap)', 'dev@wepos.id', 'v.1.0.0', 'Purchase Report (Recap)', 'purchase', 'reportPurchaseRecap', 0, '6. Reports>Purchase/Pembelian>Purchase Report (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Purchase/Pembelian>Purchase Report (Recap)', 6403, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-17 06:23:40', 'administrator', '2018-07-09 12:08:25', 1, 0),
...
(140, 'Receiving Report', 'dev@wepos.id', 'v.1.0.0', 'Receiving Report', 'inventory', 'reportReceiving', 0, '6. Reports>Receiving (In)>Receiving Report', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Receiving (In)>Receiving Report', 6501, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2018-07-17 06:31:50', 'administrator', '2018-07-09 12:00:32', 1, 0),
(143, 'Receiving Report (Recap)', 'dev@wepos.id', 'v.1.0.0', 'Receiving Report (Recap)', 'inventory', 'reportReceivingRecap', 0, '6. Reports>Receiving (In)>Receiving Report (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Receiving (In)>Receiving Report (Recap)', 6504, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-09 08:57:19', 'administrator', '2018-07-09 12:01:16', 1, 0),
(156, 'Monitoring Stock (Actual)', 'dev@wepos.id', 'v.1.0.0', 'Monitoring Stock (Actual)', 'inventory', 'reportMonitoringStock', 0, '6. Reports>Warehouse>Monitoring Stock (Actual)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Warehouse>Monitoring Stock (Actual)', 6642, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-11 16:44:12', 'administrator', '2018-07-17 17:45:36', 1, 0),
(157, 'Kartu Stok', 'dev@wepos.id', 'v.1.0.0', 'Kartu Stok', 'inventory', 'kartuStok', 0, '6. Reports>Warehouse>Kartu Stock', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Warehouse>Kartu Stock', 6643, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-02 23:43:42', 'administrator', '2018-07-17 17:46:03', 1, 0),
(176, 'Product Category', 'dev@wepos.id', 'v.1.0', '', 'master_pos', 'productCategory', 0, '2. Master POS>Product Category', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Product Category', 2101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-10 10:26:07', 'administrator', '2018-07-29 17:00:00', 1, 0),
(177, 'Master Product & Package', 'dev@wepos.id', 'v.1.0', 'Master Product & Package', 'master_pos', 'masterProduct', 0, '2. Master POS>Master Product', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Product', 2102, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-10 10:24:38', 'administrator', '2018-07-29 17:00:00', 1, 0),
(184, 'Pembayaran PPOB', 'dev@wepos.id', 'v.1.0.0', 'Pembayaran PPOB', 'cashier', 'ppob', 0, '3. Cashier & Sales Order>Pembayaran PPOB', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Sales Order>Pembayaran PPOB', 3401, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-04-09 01:25:57', 'administrator', '2019-04-09 10:49:57', 0, 0),
(190, 'Cashier Apps', 'dev@wepos.id', 'v.1.0', 'Cashier Apps', 'cashier', 'billingCashierRetailApp', 0, '3. Cashier & Sales Order>Cashier Retail (Apps)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 0, 0, '3. Cashier & Sales Order>Cashier Retail (Apps)', 3102, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2018-07-09 20:28:03', 'administrator', '2018-07-22 05:58:59', 0, 0),
(194, 'Set Auto Non-Trx/Compliment', 'dev@wepos.id', 'v.1.0.0', 'Set Auto Non-Trx/Compliment', 'billing', 'setupAutoBillingTax', 0, '3. Cashier & Sales Order>Non-Trx/Compliment>Set Auto Non-Trx/Compliment', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Sales Order>Non-Trx/Compliment>Set Auto Non-Trx/Compliment', 6120, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2020-07-30 22:51:55', 'administrator', '2020-07-31 10:47:33', 1, 0);
...
(2, 'report_place_default', 'Bandung', NULL, '2018-07-23 19:00:00', 'administrator', NULL, NULL, 1, 0),
...
(12, 'spv_access_active', 'cancel_billing,cancel_order,retur_order,unmerge_billing,change_ppn,change_service,change_dp,set_compliment_item,clear_compliment_item', NULL, '2018-07-06 20:00:00', 'administrator', NULL, NULL, 1, 0),
...
(15, 'ipserver_management_systems', 'https://wepos.id', NULL, '2018-07-11 20:00:00', 'administrator', '2019-04-25 17:00:01', NULL, 1, 0),
(16, 'multiple_store', '0', NULL, '2018-07-12 20:00:00', 'administrator', NULL, NULL, 1, 0),
(17, 'view_multiple_store', '', NULL, '2018-07-02 19:11:13', '', '2019-04-25 17:00:01', NULL, 1, 0),
(18, 'autobackup_on_settlement', '', NULL, '2018-07-02 19:11:13', '', NULL, NULL, 1, 0),
(19, 'wepos_update_version', '342211911001', NULL, '2018-07-02 19:11:21', '', NULL, NULL, 1, 0),
(20, 'wepos_update_version2', '3.42.21.1911001', NULL, '2018-07-02 19:11:21', '', NULL, NULL, 1, 0),
...
(23, 'wepos_connected_id', '18', NULL, '2018-07-02 19:13:04', '', NULL, NULL, 1, 0),
(24, 'current_date', '1574108304', NULL, '2018-07-12 20:00:00', 'administrator', NULL, NULL, 1, 0),
...
(37, 'item_code_format', '{Cat}.{SubCat}.{ItemNo}', NULL, '2018-07-11 20:00:00', 'administrator', NULL, NULL, 1, 0),
...
(47, 'stock_rekap_start_date', '01-11-2019', NULL, '2018-07-12 18:00:00', 'administrator', '2019-04-25 17:00:01', NULL, 1, 0),
...
(89, 'no_hold_billing', '', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
...
(127, 'printer_ip_cashierReceipt_default', 'pc-share-name\\printer-share-name', NULL, '2018-07-28 19:57:55', 'administrator', '2018-07-28 19:57:55', 'administrator', 1, 0),
...
(132, 'printer_ip_qcReceipt_default', 'pc-share-name\\printer-share-name', NULL, '2018-07-05 00:11:02', 'administrator', '2018-07-05 00:11:02', 'administrator', 1, 0),
...
(137, 'printer_ip_cashierReceipt_127.0.0.1', 'pc-share-name\\printer-share-name', NULL, '2018-07-28 19:57:55', 'administrator', '2018-07-28 19:57:55', 'administrator', 1, 0),
...
(142, 'printer_ip_qcReceipt_127.0.0.1', 'pc-share-name\\printer-share-name', NULL, '2018-07-05 00:11:02', 'administrator', '2018-07-05 00:11:02', 'administrator', 1, 0),
(143, 'printer_id_qcReceipt_127.0.0.1', '1', NULL, '2018-07-05 00:11:02', 'administrator', '2018-07-05 00:11:02', 'administrator', 1, 0),
(144, 'closing_sales_start_date', '01-11-2019', NULL, '2018-07-06 20:00:00', 'administrator', '2019-04-25 17:00:01', NULL, 1, 0),
(145, 'closing_purchasing_start_date', '01-11-2019', NULL, '2018-07-09 00:00:00', '', '2019-04-25 17:00:01', NULL, 1, 0),
(146, 'closing_inventory_start_date', '01-11-2019', NULL, '2018-07-02 12:00:00', '', '2019-04-25 17:00:01', NULL, 1, 0),
(147, 'closing_accounting_start_date', '01-11-2019', NULL, '2018-07-06 20:00:00', 'administrator', '2019-04-25 17:00:01', NULL, 1, 0),
...
(168, 'merchant_key', 'MERCHANT-KEY', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(169, 'merchant_tipe', 'retail', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(170, 'merchant_cor_token', '', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(171, 'merchant_acc_token', '', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(172, 'merchant_mkt_token', '', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(173, 'produk_nama', 'Gratis / Free', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(174, 'produk_key', 'GFR-1574096400', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
...
(177, 'merchant_last_check', '1574100877', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(178, 'merchant_last_checkon', '1574100788', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(179, 'hide_tanya_wepos', '', NULL, '2018-07-04 00:00:00', 'administrator', NULL, NULL, 1, 0),
(188, 'stock_rekap_last_update', '19-11-2019 03:18:20', NULL, NULL, '', NULL, NULL, 1, 0),
...
(192, 'maxday_cashier_report', '1', NULL, NULL, '', NULL, NULL, 1, 0),
(193, 'jam_operasional_from', '07:00', NULL, NULL, '', NULL, NULL, 1, 0),
(194, 'jam_operasional_to', '23:00', NULL, NULL, '', NULL, NULL, 1, 0),
(195, 'jam_operasional_extra', '', NULL, NULL, '', NULL, NULL, 1, 0),
(196, 'store_connected_name', '', NULL, '2019-04-25 17:00:01', 'administrator', NULL, NULL, 1, 0),
(197, 'store_connected_email', '', NULL, '2019-04-25 17:00:01', 'administrator', NULL, NULL, 1, 0),
(198, 'as_server_backup', '', NULL, '2019-04-25 17:00:01', 'administrator', NULL, NULL, 1, 0),
(199, 'use_wms', '', NULL, '2019-03-31 17:00:07', 'administrator', NULL, NULL, 1, 0),
(200, 'opsi_no_print_when_payment', '', NULL, '2019-04-25 17:00:01', 'administrator', NULL, NULL, 1, 0),
(201, 'using_item_average_as_hpp', '1', NULL, '2019-04-25 17:00:01', 'administrator', NULL, NULL, 1, 0),
(202, 'wepos_version', '3.42.22', NULL, '2019-04-25 17:00:01', 'administrator', NULL, NULL, 1, 0),
(203, 'app_name', 'WePOS.Retail', NULL, NULL, '', NULL, NULL, 1, 0),
(204, 'app_name_short', 'WePOS.Retail', NULL, NULL, '', NULL, NULL, 1, 0),
(205, 'app_release', '2021', NULL, NULL, '', NULL, NULL, 1, 0),
(206, 'mode_bazaar_tenant', '', NULL, NULL, '', NULL, NULL, 1, 0),
(207, 'billing_no_simple', '', NULL, NULL, '', NULL, NULL, 1, 0),
(208, 'hide_detail_taxservice', '', NULL, NULL, '', NULL, NULL, 1, 0),
(209, 'hide_detail_takeaway', '', NULL, NULL, '', NULL, NULL, 1, 0),
(210, 'hide_detail_compliment', '', NULL, NULL, '', NULL, NULL, 1, 0),
(211, 'input_harga_manual', '', NULL, NULL, '', NULL, NULL, 1, 0),
(212, 'tandai_pajak_billing', '', NULL, NULL, '', NULL, NULL, 1, 0),
(213, 'override_pajak_billing', '', NULL, NULL, '', NULL, NULL, 1, 0),
(214, 'auto_pengakuan_hutang', '', NULL, NULL, '', NULL, NULL, 1, 0),
(215, 'default_pengakuan_hutang', '', NULL, NULL, '', NULL, NULL, 1, 0),
(216, 'auto_pengakuan_piutang', '', NULL, NULL, '', NULL, NULL, 1, 0),
(217, 'default_pengakuan_piutang', '', NULL, NULL, '', NULL, NULL, 1, 0),
(218, 'wepos_update_342211911001', '', NULL, NULL, '', NULL, NULL, 1, 0);
...
(445, 5, 184, NULL, 0, 'admin', '2018-09-04 03:14:10', 'admin', '2018-09-04 03:14:10', 1, 0),
(446, 1, 176, NULL, 0, 'admin', '2018-09-04 03:14:10', 'admin', '2018-09-04 03:14:10', 1, 0),
(447, 2, 176, NULL, 0, 'admin', '2018-09-04 03:14:10', 'admin', '2018-09-04 03:14:10', 1, 0),
(448, 1, 177, NULL, 0, 'admin', '2018-09-04 03:14:10', 'admin', '2018-09-04 03:14:10', 1, 0),
(449, 2, 177, NULL, 0, 'admin', '2018-09-04 03:14:10', 'admin', '2018-09-04 03:14:10', 1, 0),
(450, 1, 184, NULL, 0, 'admin', '2018-09-04 03:14:10', 'admin', '2018-09-04 03:14:10', 1, 0),
(451, 2, 184, NULL, 0, 'admin', '2018-09-04 03:14:10', 'admin', '2018-09-04 03:14:10', 1, 0),
(452, 1, 190, NULL, 0, 'administrator', '2019-04-09 09:18:38', 'administrator', '2019-04-09 09:18:38', 1, 0),
(453, 2, 190, NULL, 0, 'administrator', '2019-04-09 09:18:38', 'administrator', '2019-04-09 09:18:38', 1, 0),
(454, 1, 194, NULL, 0, 'admin', '2020-07-31 03:14:10', 'admin', '2020-07-31 03:14:10', 1, 0),
(455, 2, 194, NULL, 0, 'admin', '2020-07-31 03:14:10', 'admin', '2020-07-31 03:14:10', 1, 0),
(456, 5, 194, NULL, 0, 'admin', '2020-07-31 03:14:10', 'admin', '2020-07-31 03:14:10', 1, 0);
...
(1, 'administrator', '202cb962ac59075b964b07152d234b70', 1, 'Admin', 'Super', 'angganugraha@gmail.com', '6281222549676', '1231239990111', 'Bandung - West Java - Indonesia', 1, 1, '0', '1', '2014-06-22 22:05:55', '1', '2015-09-10 05:22:59', 1, 0, '9999'),
(2, 'admin', '202cb962ac59075b964b07152d234b70', 2, 'Admin', 'Apps', 'admin@wepos.id', '132342424', '', '', 1, 2, '0', '1', '2014-06-22 14:35:59', 'administrator', '2016-06-05 07:56:30', 1, 0, '1234'),
...
(1, 1, 'bottom', 'full', 'default.jpg', 0, 1, 'system', '2017-05-05 18:16:17', 'system', '2017-05-05 18:16:17', 1, 0),
(2, 2, 'bottom', 'full', 'default.jpg', 0, 1, 'system', '2017-05-05 18:16:17', 'system', '2017-05-05 18:16:17', 1, 0),
...
CREATE TABLE IF NOT EXISTS `pos_floorplan` (
  ...
  `is_active` tinyint(1) DEFAULT '1',
  `is_deleted` tinyint(1) DEFAULT '0',
  `list_no` tinyint(4) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'NOTE', 'NT', '', NULL, '2017-12-16 05:05:16', NULL, '2017-12-16 05:05:16', 1, 0, 0),
(2, 'SMARTPHONE', 'SM', '', NULL, '2017-12-16 05:05:30', NULL, '2017-12-16 05:05:30', 1, 0, 0),
(3, 'CELLPHONE', 'CP', '', NULL, '2017-12-16 05:05:54', NULL, '2017-12-16 05:05:54', 1, 0, 0),
(4, 'ACCECORIES', 'ACC', '', NULL, '2017-12-16 05:06:09', NULL, '2017-12-16 05:06:09', 1, 0, 0),
(5, 'PULSA', 'PLS', '', NULL, '2017-12-16 05:06:19', NULL, '2017-12-16 05:06:19', 1, 0, 0),
(6, 'TABLET', 'TAB', '', NULL, '2017-12-16 06:08:37', NULL, '2017-12-16 06:08:37', 1, 0, 0);
...
CREATE TABLE IF NOT EXISTS `pos_item_kode_unik_log` (
  ...
  `varian_name` varchar(50) COLLATE latin1_general_ci DEFAULT NULL,
  `varian_group` varchar(50) COLLATE latin1_general_ci DEFAULT NULL,
  `is_deleted` tinyint(1) DEFAULT '0',
  `is_active` tinyint(1) DEFAULT '1'
...
(1, 'pc-share-name\\printer-share-name', 'KASIR', 'QPOS', '32 CHAR', 0, 'system', '2017-05-05 05:57:37', 'admin', '2019-04-28 14:22:22', 1, 0, 'BROWSER', 0);
...
CREATE TABLE IF NOT EXISTS `pos_salesorder` (
  `id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pos_salesorder_detail` (
  `id` bigint(20) unsigned NOT NULL,
...
(1, 'Shift Default', '07:00', '15:00', 'administrator', '2019-12-09 12:42:49', 'admin', '2020-12-14 18:22:13', 0),
(2, '', '', '', 'administrator', '2019-12-09 12:42:49', 'admin', '2020-12-14 18:22:13', 1),
(3, '', '', '', 'administrator', '2019-12-09 12:42:49', 'admin', '2020-12-14 18:22:13', 1);
...
(2, 'kg', 'Kilogram', 'admin', '2019-04-23 07:00:41', 'admin', '2019-04-23 07:00:41', 1, 0);
...
--
-- Indexes for table `pos_salesorder`
--
ALTER TABLE `pos_salesorder`
  ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `pr_number_idx` (`so_number`);

--
-- Indexes for table `pos_salesorder_detail`
--
...
--
ALTER TABLE `apps_options`
  MODIFY `id` bigint(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=219;
--
...
--
ALTER TABLE `apps_roles_module`
  MODIFY `id` smallint(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=457;
--
...
--
-- AUTO_INCREMENT for table `pos_salesorder`
--
ALTER TABLE `pos_salesorder`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pos_salesorder_detail`
--
ALTER TABLE `pos_salesorder_detail`
  MODIFY `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
