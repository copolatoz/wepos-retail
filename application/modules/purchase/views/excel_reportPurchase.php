			...
			if(!empty($report_data)){
				...
				foreach($report_data as $det){
					...
					<tr>
						...
						<td class="tbl_data_td_xright"><?php echo $det['po_discount_text']; ?></td>
						<td class="tbl_data_td_xright"><?php echo $det['po_tax_text']; ?></td>
						<td class="tbl_data_td_xright"><?php echo $det['po_total_price_cash_text']; ?></td>
						<td class="tbl_data_td_xright"><?php echo $det['po_total_price_credit_text']; ?></td>
