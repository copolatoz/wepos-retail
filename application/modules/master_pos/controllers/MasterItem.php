...
class MasterItem extends MY_Controller {
	...
	public function gridData()
	{
		...
		$params = array(
			'fields'		=> 'a.*, b.unit_name, b.unit_code, c.supplier_name, d.item_category_name, d.item_category_code,
								e.item_subcategory1_name, e.item_subcategory1_code, 
								f.item_subcategory2_name, f.item_subcategory2_code, 
								g.item_subcategory3_name, g.item_subcategory3_code, 
								h.item_subcategory4_name, h.item_subcategory4_code',
			'primary_key'	=> 'a.id',
			...
			'join'			=> array(
									...
									array( 
										...
										array($this->prefix.'item_subcategory1 as e','e.id = a.subcategory1_id','LEFT'),
										...
										array($this->prefix.'item_subcategory4 as h','h.id = a.subcategory4_id','LEFT')
									) 
								),
	...
	public function save()
	{
		...
		$subcategory4_id = $this->input->post('subcategory4_id');
		...
		if($this->input->post('form_type_masterItem', true) == 'add')
		{
			...
			$var = array(
				'fields'	=>	array(
					...
					'subcategory4_id'	=>	$subcategory4_id,
	...
	public function updateCode(){
		...
		if($get_last->num_rows() > 0){
			...
			//suggestion
			if(!empty($item_category_code) OR !empty($item_subcategory1_code) OR !empty($item_subcategory2_code) OR !empty($item_subcategory3_code) OR !empty($item_subcategory4_code)){
				$get_item_code = $this->generate_item_code($tipe);
			...
			$repl_attr = array(
				...
				"{SubCat4}"	=> $item_subcategory4_code
			);
