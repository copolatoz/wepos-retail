	...
	<table width="<?php echo $set_width; ?>">
		...
		<thead>
			...
			<tr>
				...
				<td class="tbl_head_td_xcenter" width="260">PRODUCT / ITEM</td>
		...
		if(!empty($report_data)){
			...
			<tr>
				...
				<td class="tbl_summary_td_xright"><?php echo priceFormat($total_billing); ?></td>
				<td class="tbl_summary_td_xright"><?php echo priceFormat($total_hpp); ?></td>
				<td class="tbl_summary_td_xright"><?php echo priceFormat($total_profit); ?></td>
			</tr>
			<?php
		}else{
		?>
