 ...
 * Generated 2020-11-19 at 10:10:17 PM
 */
...
var store_DataStructure_parent=theApp.getStore('systems.store_DataStructure_parent');var store_ComboboxDataClientUnit_DataStructure=theApp.getStore('store_ComboboxDataClientUnit_DataStructure',false);if(store_ComboboxDataClientUnit_DataStructure==false){store_ComboboxDataClientUnit_DataStructure=theApp.copyStore('systems','store_ComboboxDataClientUnit','store_ComboboxDataClientUnit_DataStructure');}
store_ComboboxDataClientUnit_DataStructure.proxy.extraParams.limit=9999;var store_ComboboxRoleData_DataStructure=theApp.getStore('store_ComboboxRoleData_DataStructure',false);if(store_ComboboxRoleData_DataStructure==false){store_ComboboxRoleData_DataStructure=theApp.copyStore('systems','store_ComboboxRoleData','store_ComboboxRoleData_DataStructure');}
store_ComboboxRoleData_DataStructure.proxy.extraParams.limit=9999;return desktop.createWindow({id:me.id+'_add_DataStructure',title:Titletext,width:350,height:300,iconCls:'btn-add',animCollapse:false,constrainHeader:true,resizable:false,minimizable:false,maximizable:false,modal:true,border:0,layout:{type:'fit'},items:[{xtype:'form',id:'form_DataStructure',border:0,bodyPadding:10,margin:'0 0 0 0',items:[{xtype:'hidden',name:'form_type_DataStructure',value:me.formType},{xtype:'hidden',name:'id'},{xtype:'hidden',name:'client_structure_parent'},{xtype:'combobox',name:'client_structure_parent_combo',fieldLabel:'Parent Structure',anchor:'100%',store:store_DataStructure_parent,queryMode:'local',hiddenName:"client_structure_parent_combo",displayField:'client_structure_name',valueField:'id',typeAhead:true,minChars:1,forceSelection:true,allowBlank:false,listConfig:{emptyText:'Tidak ada data Structure',minWidth:250,getInnerTpl:function(){return'{client_structure_nama_show}';}},pageSize:0,listeners:{select:{fn:function(c,r,i){Ext.getCmp('form_DataStructure').getForm().findField('client_structure_parent').setValue(c.getValue());}}}},{xtype:'textfield',name:'client_structure_name',fieldLabel:'Name Structure',anchor:'100%',allowBlank:false},{xtype:'combobox',name:'client_unit_id',fieldLabel:'Unit',anchor:'100%',store:store_ComboboxDataClientUnit_DataStructure,queryMode:'local',hiddenName:"client_unit_id",displayField:'client_unit_name',valueField:'id',typeAhead:true,minChars:1,forceSelection:true,allowBlank:false,listConfig:{emptyText:'Tidak ada data',minWidth:250,getInnerTpl:function(){return'{client_unit_name}';}},pageSize:0},{xtype:'combobox',name:'role_id',fieldLabel:'Role Aplikasi',anchor:'100%',store:store_ComboboxRoleData_DataStructure,queryMode:'local',hiddenName:"role_id",displayField:'role_name',valueField:'id',typeAhead:true,minChars:1,forceSelection:true,allowBlank:false,listConfig:{emptyText:'Tidak ada data',minWidth:250,getInnerTpl:function(){return'{role_name}';}},pageSize:0},{xtype:'textfield',name:'client_structure_notes',fieldLabel:'Keterangan',anchor:'100%'},{xtype:'textfield',name:'client_structure_order',fieldLabel:'Urutan',anchor:'50%'},{xtype:'checkbox',name:'is_active',fieldLabel:'Status Active',inputValue:'1'}]}],buttons:[{text:'Save',formBind:true,id:'btnSave_DataStructure',iconCls:'btn-save',handler:function(){me.save_DataStructure();}},{text:'Cancel',iconCls:'btn-cancel',handler:function(){me.doClose(me.id+'_add_DataStructure');}}],listeners:{show:function(){var form=Ext.getCmp('form_DataStructure').getForm();var myMask=new Ext.LoadMask(Ext.getCmp('form_DataStructure'),{msg:"Loading..."});myMask.show();if(me.formType=='edit'){form.setValues(me.edit_data);}else{form.reset();form.findField('is_active').setValue(1);form.findField('client_structure_order').setValue(0);}
var extraparams={};if(me.formType=='edit'){extraparams={id_edit:me.edit_data.id};}
store_ComboboxDataClientUnit_DataStructure.load({callback:function(records,operation,success){var client_structure_client_unit_id=0;if(me.formType=='edit'){client_structure_client_unit_id=me.edit_data.client_unit_id;}
form.findField('client_unit_id').select(client_structure_client_unit_id);}});store_ComboboxRoleData_DataStructure.load({callback:function(records,operation,success){var client_structure_role_id=0;if(me.formType=='edit'){client_structure_role_id=me.edit_data.role_id;}
form.findField('role_id').select(client_structure_role_id);}});store_DataStructure_parent.load({params:extraparams,callback:function(records,operation,success){var client_structure_parent=0;if(me.formType=='edit'){client_structure_parent=me.edit_data.client_structure_parent;}
