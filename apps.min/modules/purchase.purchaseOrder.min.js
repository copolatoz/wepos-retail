...
me.store_purchaseOrderDetailTemp.proxy.extraParams.po_id=po_id;me.store_purchaseOrderDetailTemp.proxy.extraParams.limit=99999;me.store_purchaseOrderDetailTemp.load({callback:function(){myMask.hide();var d=me.store_purchaseOrderDetailTemp.getRange(0);var total_detail=0;var total_detail_qty=0;var total_receive=0;for(var i=0;i<d.length;i++)
{total_detail+=parseFloat(d[i].data.po_detail_total);total_detail_qty+=parseFloat(d[i].data.po_detail_qty);total_receive+=parseFloat(d[i].data.po_receive_qty);}
Ext.getCmp('totalQtyDisplay_purchaseOrder').setValue(phpJs.priceFormat(total_detail_qty));if(me.edit_data.po_status!='done'){if(me.edit_data.used_on_receiving==1&&total_receive>0){ExtApp.Msg.warning('Please careful to update PO data<br/>some PO detail/item has been received');}}}});me.calculate_PO();}}}});},add_purchaseOrderDetail:function(me){var theApp=me.app;var desktop=theApp.getDesktop();var Titletext='Add Detail ';if(me.formType_Detail=='edit'){Titletext='Update Detail ';}
